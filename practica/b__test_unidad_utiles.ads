...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#20d514fc#;
   ...
   u00077 : constant Version_32 := 16#660d39d5#;
   pragma Export (C, u00077, "utilesB");
   u00078 : constant Version_32 := 16#16f53e23#;
   pragma Export (C, u00078, "utilesS");
   u00079 : constant Version_32 := 16#e18a47a0#;
   pragma Export (C, u00079, "ada__float_text_ioB");
   u00080 : constant Version_32 := 16#e61b3c6c#;
   pragma Export (C, u00080, "ada__float_text_ioS");
   u00081 : constant Version_32 := 16#d5f9759f#;
   pragma Export (C, u00081, "ada__text_io__float_auxB");
   u00082 : constant Version_32 := 16#f854caf5#;
   ...
   u00085 : constant Version_32 := 16#f0df9003#;
   pragma Export (C, u00085, "system__img_realB");
   u00086 : constant Version_32 := 16#3366ddd8#;
   pragma Export (C, u00086, "system__img_realS");
   u00087 : constant Version_32 := 16#f05937c9#;
   pragma Export (C, u00087, "system__fat_llfS");
   u00088 : constant Version_32 := 16#1b28662b#;
   pragma Export (C, u00088, "system__float_controlB");
   u00089 : constant Version_32 := 16#1432cf06#;
   pragma Export (C, u00089, "system__float_controlS");
   u00090 : constant Version_32 := 16#f1f88835#;
   pragma Export (C, u00090, "system__img_lluB");
   u00091 : constant Version_32 := 16#205f2839#;
   pragma Export (C, u00091, "system__img_lluS");
   u00092 : constant Version_32 := 16#eef535cd#;
   pragma Export (C, u00092, "system__img_unsB");
   u00093 : constant Version_32 := 16#f662140d#;
   pragma Export (C, u00093, "system__img_unsS");
   u00094 : constant Version_32 := 16#a4beea4d#;
   pragma Export (C, u00094, "system__powten_tableS");
   u00095 : constant Version_32 := 16#faa9a7b2#;
   pragma Export (C, u00095, "system__val_realB");
   u00096 : constant Version_32 := 16#0ae7fb2b#;
   pragma Export (C, u00096, "system__val_realS");
   u00097 : constant Version_32 := 16#6c05c057#;
   pragma Export (C, u00097, "system__exn_llfB");
   u00098 : constant Version_32 := 16#48b037e6#;
   pragma Export (C, u00098, "system__exn_llfS");
   u00099 : constant Version_32 := 16#acbb902e#;
   pragma Export (C, u00099, "system__fat_fltS");
   u00100 : constant Version_32 := 16#f64b89a4#;
   pragma Export (C, u00100, "ada__integer_text_ioB");
   u00101 : constant Version_32 := 16#f1daf268#;
   ...
   u00104 : constant Version_32 := 16#18d57884#;
   pragma Export (C, u00104, "system__img_biuB");
   u00105 : constant Version_32 := 16#afb4a0b7#;
   pragma Export (C, u00105, "system__img_biuS");
   u00106 : constant Version_32 := 16#e7d8734f#;
   pragma Export (C, u00106, "system__img_llbB");
   u00107 : constant Version_32 := 16#ee73b049#;
   pragma Export (C, u00107, "system__img_llbS");
   u00108 : constant Version_32 := 16#9777733a#;
   pragma Export (C, u00108, "system__img_lliB");
   u00109 : constant Version_32 := 16#e581d9eb#;
   pragma Export (C, u00109, "system__img_lliS");
   u00110 : constant Version_32 := 16#0e8808d4#;
   pragma Export (C, u00110, "system__img_llwB");
   u00111 : constant Version_32 := 16#471f93df#;
   pragma Export (C, u00111, "system__img_llwS");
   u00112 : constant Version_32 := 16#428b07f8#;
   pragma Export (C, u00112, "system__img_wiuB");
   u00113 : constant Version_32 := 16#c1f52725#;
   pragma Export (C, u00113, "system__img_wiuS");
   u00114 : constant Version_32 := 16#7ebd8839#;
   pragma Export (C, u00114, "system__val_intB");
   u00115 : constant Version_32 := 16#bc6ba605#;
   pragma Export (C, u00115, "system__val_intS");
   u00116 : constant Version_32 := 16#b3aa7b17#;
   pragma Export (C, u00116, "system__val_lliB");
   u00117 : constant Version_32 := 16#6eea6a9a#;
   pragma Export (C, u00117, "system__val_lliS");
   u00118 : constant Version_32 := 16#06052bd0#;
   pragma Export (C, u00118, "system__val_lluB");
   u00119 : constant Version_32 := 16#13647f88#;
   pragma Export (C, u00119, "system__val_lluS");
   u00120 : constant Version_32 := 16#af50e98f#;
   pragma Export (C, u00120, "ada__stringsS");
   u00121 : constant Version_32 := 16#f78329ae#;
   pragma Export (C, u00121, "ada__strings__unboundedB");
   u00122 : constant Version_32 := 16#e303cf90#;
   pragma Export (C, u00122, "ada__strings__unboundedS");
   u00123 : constant Version_32 := 16#d22169ac#;
   ...
   u00132 : constant Version_32 := 16#5dcdfdb7#;
   ...
   u00134 : constant Version_32 := 16#e7c23209#;
   pragma Export (C, u00134, "system__address_operationsS");
   u00135 : constant Version_32 := 16#6a859064#;
   ...
   u00138 : constant Version_32 := 16#55221100#;
   pragma Export (C, u00138, "system__address_imageS");
   u00139 : constant Version_32 := 16#b5b2aca1#;
   pragma Export (C, u00139, "system__finalization_mastersB");
   u00140 : constant Version_32 := 16#80d8a57a#;
   ...
   u00149 : constant Version_32 := 16#e5ac57f8#;
   pragma Export (C, u00149, "system__atomic_countersB");
   u00150 : constant Version_32 := 16#39b218f0#;
   ...
   u00154 : constant Version_32 := 16#54b8a3b7#;
   pragma Export (C, u00154, "ada__text_io__unbounded_ioS");
   u00155 : constant Version_32 := 16#97a2d3b4#;
   pragma Export (C, u00155, "ada__strings__unbounded__text_ioB");
   u00156 : constant Version_32 := 16#2124c8bb#;
